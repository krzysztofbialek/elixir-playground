defmodule Issues.CLI do
  ...
  Return tuple of `{user,project,count}`, or `:help` if help was give
  """
  ...
  #   for row <- rows do
  #     # IO.puts Map.get(row, "number")
  #     IO.puts "#{Map.get(row, "number")} | #{Map.get(row, "created_at")} | #{Map.get(row, "title")}"
  #   end
  # end
end
